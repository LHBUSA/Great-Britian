...
<div class="docs-shell-v2">
  ...
  "provenance": [ ... ]
      ...
      <section class="doc-section-v2" id="routes">
        ...
        <p>The mistake is to turn “how many endpoints are GB-certified today?” into the product story. The GB-native launch contract centers on the property resolver, while the broader PropData platform also exposes account, health, stats and changelog routes and 20+ production routes across the overall platform. Do not assume a global route has GB-specific enrichment unless the country contract or returned coverage explicitly supports it. fileciteturn38file0L1-L67</p>
        ...
        <div class="callout-v2 warn"><b>Important:</b> PropData’s wider route catalog includes market, rent, estimate, comps, geocode, parcel geometry, neighborhood, deltas, preforeclosure and more across the overall platform. That does not automatically certify those routes for GB. Country availability must be verified separately. fileciteturn38file0L6-L67</div>
      </section>
